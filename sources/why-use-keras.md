...
Keras 모델은 여러 [딥러닝 백엔드](https://keras.io/backend/)를 지원합니다. 눈여겨볼 만한 점은 내장 레이어로만 구성된 Keras 모델을 여러 백엔드에 적용 가능합니다. 학습에 사용되는 백엔드와 배포 등을 위한 로드에 사용되는 백엔드가 서로 달라도 됩니다. 사용 가능한 백엔드들은 다음과 같습니다.
