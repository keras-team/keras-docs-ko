...
Keras 모델은 여러 [딥러닝 백엔드](https://keras.io/backend/)들로 개발할 수 있습니다. 여기서 눈여겨 볼만한 점은 일부 내장 레이어의 보조가 되는 Keras 모델이라도 여러 백엔드에 적용이 가능합니다. 특정 모델을 훈련시키는 백엔드와 모델을 는 백엔드가 서로 달라도 됩니다. 사용 가능한 백엔드들은 다음과 같습니다.
